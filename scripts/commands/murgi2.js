...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("স্বাধীন বস আপনি খালি মেনশন দেন কারে চুদতে হবে একবারে বাপ ডাকাবো", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("খা স্বাধীনের চুদা");
setTimeout(() => {a({body: "1" + " " + name, mentions: arraytag})}, 3000);
setTimeout(() => {a({body: "2" + " " + name, mentions: arraytag})}, 5000);
setTimeout(() => {a({body: "3" + " " + name, mentions: arraytag})}, 7000);
setTimeout(() => {a({body: "BOOM Boom Boom Boom Boom !" + " " + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "খাংকি মাগির পোলা কথা ক কম কম তর আম্মু রে চুদে বানামু আইটেম বোম " + " " + name, mentions: arraytag})}, 12000);
setTimeout(() => {a({body: "🤬 এই বাইনচোদ তোর সহস কতো ? আমার বস কে গালি দিছোস 😏 " + " " + name, mentions: arraytag})}, 15000);
setTimeout(() => {a({body: "তোরে যে সেদিন চুদলাম মনে নাই ?? 😂 বাইনচোদ " + " " + name, mentions: arraytag})}, 17000);

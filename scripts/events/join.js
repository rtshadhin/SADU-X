...
.then(response => {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    return api.sendMessage("HEY I'M ROBOT 🤖 Thanks for added me This group BOT ADMIN-SHADHIN", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
🟢SUPPORT EMAIL: www.rtshadhin@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
  }})
.catch(error => {
    console.error(error);
});
    ...
    try {
      ...
      for (let o = 0; o < event.logMessageData.addedParticipants.length; o++) {
        ...
        var ok = [
          'https://i.imgur.com/2v2gn2l.jpeg',
          'https://i.imgur.com/2v2gn2l.jpeg',
          'https://i.imgur.com/2v2gn2l.jpeg',
          'https://i.imgur.com/2v2gn2l.jpeg',
          'https://i.imgur.com/2v2gn2l.jpeg'
